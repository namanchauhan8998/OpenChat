...
<!--      <q-drawer-->
<!--        content-style="background-color:#1976D2"-->
<!--        v-model="drawer"-->
<!--        show-if-above-->
<!--        :mini="true"-->
<!--        :breakpoint="500"-->
...
<!--        <q-list >-->
<!--          <q-item clickable v-ripple v-for="(item,index) in drawerItems" :key="item.title" :to="item.to" >-->
    ...
    data () {
      return {
        ...
        drawerItems:[
          ...
          {title:'Messages',icon:'message',to:'/message'},
