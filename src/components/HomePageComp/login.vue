<template>
  <div class="row justify-center">
    <q-card bordered class="col-xs-11 col-sm-11 col-md-8 col-lg-6 shadow-20  self-center bg-grey-3"   style="min-width:40%;border-radius: 15px ; ;" >
      <q-card-section>
        <div class="col-10">
...
<!--                <q-img src=""></q-img>-->
          ...
          <q-input class="col-12  q-py-md " rounded filled outlined v-model="password" label="Password" >
            <template v-slot:append>
              <q-avatar>
<!--                <q-img src="../statics/icons/https-24px.svg"></q-img>-->
              </q-avatar>
            </template>
          </q-input>
        ...
        <div class="row justify-center q-py-lg">
          <q-btn class="col-5 center bg-grey-3 " rounded push unelevated color="" text-color="black" label="Login" @click="check" :to="to" />
        </div>
        <div class="row justify-center ">
